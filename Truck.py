...
class Truck:
    def __init__(self, size=16):
        ...
        self.truck1_set = [1, 8, 13, 14, 15, 16, 20, 29, 30, 31, 37, 40]  # packages with early deadlines
        self.truck2_set = [3, 6, 17, 18, 19, 21, 22, 23, 24, 25, 26, 34, 36, 38]  # truck goes out same time with #1
        self.truck3_set = [2, 4, 5, 7, 9, 10, 11, 12, 27, 28, 32, 33, 35, 39]  # packages that must leave later, 6 and 25 must be near start
